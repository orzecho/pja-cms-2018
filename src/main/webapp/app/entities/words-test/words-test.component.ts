...
@Component({
    selector: 'jhi-words-test',
    templateUrl: './words-test.component.html'
})
export class WordsTestComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.wordsTestService
            ...
            .subscribe(
                (res: HttpResponse<IWordsTest[]>) => this.paginateWordsTests(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInWordsTests();
    }
    ...
    trackId(index: number, item: IWordsTest) {
        return item.id;
    }
    ...
    private paginateWordsTests(data: IWordsTest[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.wordsTests = data;
    }
