    ...
    describe('Word Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/words';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Word', () => {
                service.create(new Word(null)).subscribe(received => {
            ...
            it('should update a Word', () => {
                service.update(new Word(123)).subscribe(received => {
