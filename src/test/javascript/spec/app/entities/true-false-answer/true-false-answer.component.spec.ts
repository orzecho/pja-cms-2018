...
import { TrueFalseAnswerComponent } from 'app/entities/true-false-answer/true-false-answer.component';
...
describe('Component Tests', () => {
    describe('TrueFalseAnswer Management Component', () => {
        let comp: TrueFalseAnswerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TrueFalseAnswerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.trueFalseAnswers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
