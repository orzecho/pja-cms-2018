...
describe('Service Tests', () => {
    describe('ExamResult Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ExamResultService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/exam-results';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ExamResult', () => {
                service.create(new ExamResult(null)).subscribe(received => {
            ...
            it('should update a ExamResult', () => {
                service.update(new ExamResult(123)).subscribe(received => {
