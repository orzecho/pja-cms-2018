...
import { WrittenAnswerComponent } from 'app/entities/written-answer/written-answer.component';
...
describe('Component Tests', () => {
    describe('WrittenAnswer Management Component', () => {
        let comp: WrittenAnswerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WrittenAnswerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.writtenAnswers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
